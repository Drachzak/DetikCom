...
class AdaoterNewsIndo : RecyclerView.Adapter<AdaoterNewsIndo.ViewHolder>() {

    private var listdatanewsindo: ArrayList<ArticlesItem> = arrayListOf()

    @SuppressLint("NotifyDataSetChanged")
    fun adddatanews(xrplambildata : List<ArticlesItem>){
        listdatanewsindo.clear()
        listdatanewsindo.addAll(xrplambildata)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var dataartikel = listdatanewsindo[position]
    ...
    override fun getItemCount() = listdatanewsindo.size
