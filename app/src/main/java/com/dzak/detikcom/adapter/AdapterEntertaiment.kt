...
class AdapterEntertaiment: RecyclerView.Adapter<AdapterEntertaiment.ViewHolder>() {

    private var listdatabusiness: ArrayList<ArticlesItem> = arrayListOf()

    @SuppressLint("NotifyDataSetChanged")
    fun adddatanews(entertainmentambildata: List<ArticlesItem>) {
        listdatabusiness.clear()
        listdatabusiness.addAll(entertainmentambildata)
